...
<body>
    ...
    <%-- scriptlet 작성법 --%>
    <% pageContext.setAttribute("sum1", 10); %>
    ...
    <h1>4. 조건문 - if ~ else if ~ else <br> 
    ( c:choose, c:when, c:otherwise )</h1>
    ...
    <pre>
    	...
    	5) items(요소들) : 반복 접근할 객체(배열, 컬렉션 객체)
    	...
    	6) varStatus     : 현재 반복 상태와 관련된 정보를 제공하는 변수 선언
    		...
    		* varStatus에서 제공되는 값
    		...
    		- first   : 첫 번째 반복이면 t, 아니면 f
    		- last    :  마지막 반복이면 t, 아니면 f
       </pre>
