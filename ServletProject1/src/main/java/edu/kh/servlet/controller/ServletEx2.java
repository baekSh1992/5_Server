...
// Servlet 코드는 작성하기 위해서는 HttpServlet을 상속 받아야 한다.
public class ServletEx2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 전달된 input 태그의 값을(파라미터=String) 얻어와서 변수에 저장
		...
		// rea.getParameter() -> 여러 값 중 첫 번째 값만 얻어옴(String타입)
		// rea.getParameterValues() -> 여러 값을 모두 얻어옴(String[] 타입)
//										단, 값이 하나도 없으면 null
...
//		String opt = req.getParameter("opt");
		...
		// HTML 코드를 응답용 스트림을 이용해서 출력 -> HTML 코드로 해석되어 보여짐
