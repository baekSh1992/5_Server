...
BEGIN 
		FOR I IN 1..2000 LOOP
			...
			VALUES(SEQ_BOARD_NO.NEXTVAL,
							...
							DEFAULT, DEFAULT, DEFAULT, DEFAULT, 9,
							CEIL(DBMS_RANDOM.VALUE(0,3) ) );
		END LOOP; -- PL/SQL의 FOR문 끝을 의미
END;
/ -- /는 PL/SQL의 끝을 의미 
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
	'20221116105843_00001.gif', '1.gif', 0, 2002);

INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '20221116105843_00002.gif', '2.gif', 0, 2000);
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
   '20221116105843_00004.gif', '4.gif', 0, 1997);
  
 COMMIT;

-- BOARD_LIKE 테이블 샘플데이터 삽입
SELECT * FROM BOARD_LIKE;
INSERT INTO BOARD_LIKE VALUES(1996, 9);
INSERT INTO BOARD_LIKE VALUES(1999, 9);

COMMIT;


-- 특정 게시판 목록 조회
-- 게시글번호, 제목, 작성자닉네임, 조회수, 작성일 + 댓글 갯수, 좋아요 갯수, 썸네일
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1998, 8, null);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 1998, 9, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 1998, 1, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 1998, 8, 2001);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 1998, 9, 2002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 1998, 9, 2002);
COMMIT;
...
CONNECT BY PRIOR  COMMENT_NO = PARENT_NO -- 부모 -> 자식 계층구조 
...
INSERT INTO BOARD_NO VALUES(SEQ_BOARD_CODE.NEXTVAL, '게시판 번호');
INSERT INTO MEMBER_NO VALUES(SEQ_BOARD_CODE.NEXTVAL, '회원 번호');
